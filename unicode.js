...
let firstCharCodeInput2 = inputString2.charCodeAt(0);
let lastCharCodeInput2 = inputString2.charCodeAt(5);
let swappedString = String.fromCharCode(lastCharCodeInput2) + "aunc" + String.fromCharCode(firstCharCodeInput2);
